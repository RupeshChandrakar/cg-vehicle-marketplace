      ...
      <div className="space-y-3 rounded-2xl bg-primary-light p-4 shadow-card">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 rounded-2xl bg-primary px-4 py-2.5 text-sm font-semibold text-white shadow-btn transition hover:bg-primary-dark active:scale-[0.97] disabled:opacity-50 disabled:active:scale-100"
          >
