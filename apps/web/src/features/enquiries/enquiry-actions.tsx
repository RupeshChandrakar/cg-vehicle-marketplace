  ...
  return (
    <div className="flex gap-3">
      ...
      <button
        ...
        className="flex flex-1 items-center justify-center gap-2 rounded-full bg-foreground px-4 py-3 text-sm font-semibold text-white shadow-btn transition active:scale-[0.97]"
      >
